...
<div class="back-wrap report-form">
    ...
    <popSeeImg :id="'stockSec'" :pop="pop.popSeeImg" @closePop="closePop('popSeeImg')"></popSeeImg>
...
import { getSecondChekcUnderLineOrders, doCheckSecond } from '@/api/checkManage'
export default {
  ...
  methods: {
    ...
    getList(obj, callback) {
      ...
      this.loading = true
      getSecondChekcUnderLineOrders(opt).then((res) => {
        this.loading = false
