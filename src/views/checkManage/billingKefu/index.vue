...
<div class="cao_form">
    ...
    <el-table border stripe v-loading="loading" :data="tableData"  class="tableMod" ref="tableMod" style="width:100%">
        ...
        <el-table-column  label="操作"  align="center" >
            <template slot-scope="scope">
                <a class="blue" @click="toPopSee('popBilling', scope.row.msgdata, scope.row.id)">查看开票信息</a>
            </template>
        </el-table-column> 
    </el-table>
    ...
    <popBilling :pop='pop.popBilling' :typeCheck="true" @closePop="closePop('popBilling', $event)"></popBilling>
</div>
</template>
<script>
