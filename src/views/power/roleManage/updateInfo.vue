<template>
    <div class="app-dialog">
        <el-dialog title="修改角色" :visible.sync="popShow" width="470px" center @close="closePop()">
...
<script>
import { updatePower } from '@/api/power'
export default {
    props:{
        pop: {
            type: Object,
    ...
    watch: {
        pop:{
            handler(value) {
                ...
                this.popData.info = value.data.info;
    ...
    methods: { 
        ...
        subMit() {
            this.loading= true
            updatePower(this.popData).then(res => {
                this.loading= false
