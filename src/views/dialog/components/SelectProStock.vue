<template>
    <div class="app-dialog">
        <el-button type="link"  @click="SelectProStock=true" style="width:150px;">选择商品-库存</el-button>

        <el-dialog title="选择商品-库存" :visible.sync="SelectProStock" width="1208px" center>
            ...
            <el-table border stripe :data="testTable"  class="tableMod" ref="tableMod" style="width:100%">
                ...
                <el-table-column label="进货单价（元）"  align="center"><template slot-scope="scope"><div>￥{{scope.row.t7}}</div></template></el-table-column>
                <el-table-column label="进货总价（元）"  align="center"><template slot-scope="scope"><div>￥{{scope.row.t8}}</div></template></el-table-column>                   
            </el-table>  
