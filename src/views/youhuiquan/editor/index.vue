<template>
  <div class="back-wrap pg_yhq_add">
    ...
    <!-- 购物赠券 -->
    <!-- <from-shop v-if="ruleForm.type === '2'" ref="shop" :giveList="cardFanWei"></from-shop> -->
    <!-- <from-register ref="register"></from-register> -->
    <el-button type="primary" @click="submitForm('ruleForm')" round class="submitBtn">提交修改</el-button>
  </div>
</template>
